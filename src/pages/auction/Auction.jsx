        ...
        <div className='item section__padding'>
            ...
            <div className="item-content">
                ...
                <div className="item-content-buy">
                    <Link to={`/createResell/${tokenId}`}>
                        <button className="primary-btn"> Create Sell</button>
                    </Link>
                    <Link to={`/createAuction/${tokenId}`}>
                        <button className="secondary-btn">Create Auction</button>
                    </Link>
                </div>
